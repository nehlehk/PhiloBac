...
# cmpTrees = '/home/nehleh/PhiloBacteria/Summary_Results/all_cmpTrees.result'
...
ax1 = sns.boxplot(x = 'otherTrees', y="Quartet" ,data=g_df)
ax1 = sns.stripplot(x = 'otherTrees', y="Quartet" ,data=g_df,  jitter=True, dodge=True, marker='o', color=".1")
ax1.set_title('Quartet' , fontsize=9)



ax2 = fig.add_subplot(2, 4, 2)
ax2 = sns.boxplot(x = 'otherTrees', y="PathDiffernce" ,data=g_df )
ax2 = sns.stripplot(x = 'otherTrees', y="PathDiffernce" ,data=g_df,  jitter=True, dodge=True, marker='o', color=".1")
ax2.set_title('PathDiffernce' , fontsize=9)


ax3 = fig.add_subplot(2, 4, 3)
ax3 = sns.boxplot(x = 'otherTrees', y="RF" ,data=g_df )
ax3 = sns.stripplot(x = 'otherTrees', y="RF" ,data=g_df,  jitter=True, dodge=True, marker='o', color=".1")
ax3.set_title('RF' , fontsize=9)

ax4 = fig.add_subplot(2, 4, 4)
ax4 = sns.boxplot(x = 'otherTrees', y="MatchingSplit" ,data=g_df )
ax4 = sns.stripplot(x = 'otherTrees', y="MatchingSplit" ,data=g_df,  jitter=True, dodge=True, marker='o', color=".1")
ax4.set_title('MatchingSplit' , fontsize=9)

ax5 = fig.add_subplot(2, 4, 5)
ax5 = sns.boxplot(x = 'otherTrees', y="UMAST" ,data=g_df )
ax5 = sns.stripplot(x = 'otherTrees', y="UMAST" ,data=g_df,  jitter=True, dodge=True, marker='o', color=".1")
